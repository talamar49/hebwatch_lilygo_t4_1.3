...
{
public:
    StringArrObj(const std::vector<String> str_arr_, const int32_t x_, const  int32_t y_, const int32_t width_, const int32_t height_, const uint8_t *font_)
                : TextObj(x_, y_, width_, height_, font_),
                  str_arr(str_arr_)
                  {}
    
    const std::vector<String> str_arr;
};